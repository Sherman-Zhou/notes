package com.sec.srm.order.util;
...
import com.sec.srm.order.common.service.util.SpringContextUtils;
...
public class QueryParams<T> implements Specification<T> {
    ...
    @SuppressWarnings("unchecked")
    public Predicate apllySearchConditions(Root<T> root, CriteriaBuilder criteriaBuilder, Predicate restrictions) {
    ...
    public Predicate toPredicate(Root<T> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        ...
        return cb.and(apllySearchConditions(root, cb, restrictions));
    }
